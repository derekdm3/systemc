...
static inline void gen_bcond(DisasContext *ctx, int type)
{
    ...
    if ((bo & 0x4) == 0) {
        ...
        tcg_gen_brcondi_tl ((bo & 0x2) ? TCG_COND_NE : TCG_COND_EQ,
                            temp, 0, l1);
        tcg_temp_free(temp);
    }
    if ((bo & 0x10) == 0) {
        ...
        tcg_gen_brcondi_tl ((bo & 0x8) ? TCG_COND_EQ : TCG_COND_NE,
                            temp, 0, l1);
...
GEN_HANDLER(dcbtls, 0x1F, 0x06, 0x05, 0x02000001, PPC_CACHE),
